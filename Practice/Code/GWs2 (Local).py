                    ...
                    if d['Deadline']<=timetick:
                        if d['GW'] == GW:
                            ...
                            if(d['OFLD'] > 0):
                                ...
                                if FMW1 > FMW3 and FMW1 > -1:
                                    d['OFLD'] = 1
                                elif FMW3 > FMW1 and FMW3 >-1:
                                    d['OFLD'] = 3
                                else:
                                    d['OFLD'] = -999
...
if __name__=="__main__":
    ...
    if tasknum == 3 and uti ==1.0:
        ...
        Task =[{"Exe":0.136,"Period":0.2,"Deadline":0,'Arrival':-0.2,"Remain":0,'id':1,"Cnt":0,"OFLD":-999,"OFLDorg":-999,"state":0,"GW":2,"VD":0,"batt":1.0,"uti":0,"time":0},
                    {"Exe":0.020,"Period":0.2,"Deadline":0,'Arrival':-0.2,"Remain":0,'id':2,"Cnt":0,"OFLD":-999,"OFLDorg":-999,"state":0,"GW":2,"VD":0,"batt":1.0,"uti":0,"time":0},
