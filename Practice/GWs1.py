...
class MyTCPHandler(SocketServer.BaseRequestHandler):
    ...
    def handle(self):
        ...
        '''
        Task =[{"Exe":0.45,"Period":1,"Deadline":0,'Arrival':-1,"Remain":0,'id':1,"Cnt":0,"OFLD":-999,"OFLDorg":-999,"state":0,"GW":1,"VD":0,"CC":0,"GW2":1,"GW3":0.3},
                {"Exe":1.98,"Period":4,"Deadline":0,'Arrival':-4,"Remain":0,'id':2,"Cnt":0,"OFLD":-999,"OFLDorg":-999,"state":0,"GW":1,"VD":0,"CC":0,"GW2":1,"GW3":0.3},
                {"Exe":0.40,"Period":8,"Deadline":0,'Arrival':-8,"Remain":0,'id':3,"Cnt":0,"OFLD":-999,"OFLDorg":-999,"state":0,"GW":1,"VD":0,"CC":0,"GW2":1,"GW3":0.3}]
                ...
                try:
                    ...
                    if taskCB3:
                        ...
                        if taskCB3['GW']==1:
                            ...
                            for d in Task:
                                if d['OFLD'] == -999:
                                    taskCB3['GW1'] += d['Exe']/d['Period']
                                elif d['OFLD'] == -1:
                                    taskCB3['GW1'] += (2*offloadingTrans)/d['Period']
                                elif d['OFLD'] > 0:
                                    taskCB3['GW1'] += (2*fogtrans)/d['Period']
                                taskCB3['GW1'] += taskCB3['Exe']/taskCB3['VD']
                            Task.append(taskCB3)
                ...
                try:
                    ...
                    if taskCB2:
                        ...
                        if taskCB2['GW']==1:
                            ...
                            for d in Task:
                                if d['OFLD'] == -999:
                                    taskCB2['GW1'] += d['Exe']/d['Period']
                                elif d['OFLD'] == -1:
                                    taskCB2['GW1'] += (2*offloadingTrans)/d['Period']
                                elif d['OFLD'] > 0:
                                    taskCB2['GW1'] += (2*fogtrans)/d['Period']
                            taskCB2['GW1'] += taskCB2['Exe']/taskCB2['VD']
                            Task.append(taskCB2)
                    ...
                    if d['Deadline']<=timetick:
                        if d['GW'] == 1:
                            ...
                            if(d['OFLD'] > 0):
                                ...
                                '''if d ['GW2'] >= d['GW3'] and d['GW3'] < 1:
                                    d['OFLD'] = 3
                                elif d ['GW3'] > d['GW2'] and d['GW2'] < 1:
                                    d['OFLD'] = 2
                                else:
                                    d['OFLD'] = -999
                                '''                                
